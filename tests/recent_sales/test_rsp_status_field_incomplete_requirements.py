...
def test_rsp_status_field_incomplete_requirements(page):
    def _log(msg: str) -> None:
        print(f"[RSP][Status=Incomplete Requirements] {msg}")
    ...
    _log('Setting Status = "Incomplete Requirements".')
    ...
    assert selected_status == "Incomplete Requirements", (
        f"Expected Status selection to be 'Incomplete Requirements', got {selected_status!r}"
    )
    ...
    if not has_rows:
        try:
            ...
            pytest.skip(
                "No records found for Market Actor='AF Supply' and Status='Incomplete Requirements' "
    ...
    def verify_status_cell(cell, *, stage: str) -> None:
        ...
        expected = "Incomplete Requirements"
        assert (expected in cell_text) or (expected in help_text_text), (
            f"Expected {expected!r} to appear in the first-row Status cell "
        ...
        _log(f"Status cell OK: shows {expected!r} (text and/or help-text).")
    ...
    _log(
        "PASSED: Market Actor='AF Supply', Status='Incomplete Requirements', Invoice Date='All'; "
        "clicked Search; verified first-row Status cell indicates 'Incomplete Requirements'; "
